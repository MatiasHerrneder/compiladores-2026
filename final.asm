...
.DATA
  ...
  _2_0 	dd 	2.0
  _condicinn_compuesta_verdadera 	db 	"condición compuesta verdadera", '$'
  _1 	dd 	1.0
  _12 	dd 	12.0
  _comparador 	dd 	?
  _contador   	dd 	?
...
; --- EVALUACION AND (PARTE 2) ---
  ...
  ffree ST(0)		; Libera espacio FPU
  ffree ST(1)		; Libera espacio FPU
  jna Etiq_Falso_And_11
Etiq_Falso_And_11:
  nop			; Punto de salida del falso cortocircuito Etiq_Else_9
; --- BLOQUE THEN ---
; --- SENTENCIA SHOW (IMPRESION) ---
  mov dx, OFFSET _condicinn_compuesta_verdadera	; Carga la direccion real de la cadena
  mov ah, 9			; Funcion de DOS para imprimir string
  int 21h			; Interrupcion de sistema
...
; --- SENTENCIA SHOW (IMPRESION) ---
  ...
  fadd			; Suma ST(1) + ST(0) y hace pop
  fstp @aux12		; Descarga el resultado en el temporal

  DisplayFloat @aux12, 2	; Invoca macro de impresion para numeros
...
Etiq_Inicio_Repeat_13:
  ...
  fld @aux14		; Carga el resultado final de la expresion
  fstp _a		; Asigna sacando el valor de la FPU
; --- SENTENCIA SHOW (IMPRESION) ---
